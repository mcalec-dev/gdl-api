...
document.addEventListener('DOMContentLoaded', function () {
  ...
  async function updateStats() {
    ...
    try {
      ...
      document.getElementById('total-directories').textContent = data.collections.totalDirectories.toLocaleString();
      document.getElementById('total-files').textContent = data.collections.totalFiles.toLocaleString();
      document.getElementById('total-size').textContent = formatSize(data.collections.totalSize);
      document.getElementById('average-file-size').textContent = formatSize(data.collections.averageFileSize);
      ...
      document.getElementById('refresh-time').textContent = `Last updated: ${new Date(data.api.timestamp).toLocaleString()}`;
