    ...
    if (['jpg', 'jpeg', 'png', 'gif', 'webp', 'bmp', 'svg'].includes(ext)) {
      ...
      mediaElement.addEventListener('error', () => {
        imageContainer.innerHTML =
          '<div class="error">Could not load image preview.</div>'
      })
      ...
      mediaElement.addEventListener('error', () => {
        imageContainer.innerHTML =
          '<div class="error">Could not load video preview.</div>'
      })
    }
    if (isMedia) {
      ...
      imageContainer.innerHTML =
        '<div class="file-info">No preview available for this file type.</div>'
    }
